...
class Alexnet(normal_base):
    ...
    def build(self):
        ...
        current_tensor = self.Utils.conv2d_bn_relu("conv5", current_tensor, [3, 3, 128, 128], [1, 1])
        ...
        current_tensor = self.Utils.fc_relu("fc1", current_tensor, [512, 1024])
        current_tensor = self.Utils.fc_relu("fc2", current_tensor, [1024, 1024])
        self.result    = self.Utils.fc(current_tensor, [1024, 100])
